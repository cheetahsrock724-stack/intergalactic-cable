...
export const render: ChannelRenderer = (ctx, f) => {
  ...
  const plated = photoBackdrop(ctx, f, { zoom: 1.03, biasY: 0.1, tint: '#38bdf8', haze: 'rgba(125,211,252,0.18)', scrim: 0.4 })
  ...
  filmPass(ctx, f, { grain: 0.06, bloom: 0.38, radius: 17, haze: 'rgba(186,230,253,0.16)', hazeStrength: 0.14 })
}
